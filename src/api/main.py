...
app = FastAPI(
    ...
    description="Knowledge base management agent that identifies content gaps, generates help articles from resolved tickets, maintains article freshness, optimizes search relevance, and tracks article effectiveness.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
